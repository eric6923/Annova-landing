    ...
    <div className=" bg-black text-white font-[Inter]">
      <div className="px-4 md:px-6">
        ...
        <div className="relative">
          {/* Desktop Line */}
          <div className="hidden md:block absolute top-[45px] left-[20%] right-[20%] h-[2px] bg-gray-800" />
          
          {/* Mobile Layout */}
          <div className="md:hidden">
            <div className="flex justify-between items-start relative">
              {/* Horizontal line connecting steps */}
              <div className="absolute top-[35px] left-[40px] right-[40px] h-[2px] bg-gray-800" />
          ...
          <div className="hidden md:grid md:grid-cols-3 gap-6">
            {steps.map((step, index) => (
              ...
              >
                ...
                <h2 className="text-3xl font-bold text-[#ff4d4d] mb-4">{step.title}</h2>
