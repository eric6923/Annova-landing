        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div className="bg-violet-500/5 rounded-lg p-6 backdrop-blur-sm border border-violet-500/10 transition-all duration-300 hover:border-violet-500/30">
              ...
              <p className="text-gray-400 text-base leading-relaxed">Evaluating requirements and choosing the right technologies for your project's success</p>
            </div>
            <div className="bg-violet-500/5 rounded-lg p-6 backdrop-blur-sm border border-violet-500/10 transition-all duration-300 hover:border-violet-500/30">
              <Palette className="w-6 h-6 text-violet-500 mb-3" />
              <h4 className="text-white text-lg font-semibold mb-3">Design Planning</h4>
              <p className="text-gray-400 text-base leading-relaxed">Creating wireframes and establishing design direction aligned with your brand</p>
            </div>
          </div>
        </div>
      ),
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              ...
              <Palette className="w-6 h-6 text-violet-500 mb-3" />
                ...
                <p className="text-gray-400 text-base leading-relaxed">Creating responsive and intuitive interfaces that delight users</p>
              </div>
              <div className="bg-violet-500/5 rounded-lg p-6 backdrop-blur-sm border border-violet-500/10 transition-all duration-300 hover:border-violet-500/30">
              <Cpu className="w-6 h-6 text-violet-500 mb-3" />
                <h4 className="text-white text-lg font-semibold mb-3">Backend Integration</h4>
                <p className="text-gray-400 text-base leading-relaxed">Building robust and scalable systems for long-term success</p>
              </div>
            </div>
          </div>
        </div>
