  ...
  const services = [
    {
      ...
      description: "Implementing advanced machine learning solutions that transform data into actionable insights and predictions."
    },
    {
      icon: <Network className="w-6 h-6 md:w-8 md:h-8" />,
      title: "Neural Networks",
      description: "Developing deep learning systems that excel at pattern recognition and complex problem-solving."
    },
    {
      icon: <Database className="w-6 h-6 md:w-8 md:h-8" />,
      title: "AI Data Analytics",
      description: "Leveraging AI-powered analytics to uncover valuable insights and drive data-informed decisions."
    },
    {
      icon: <Cpu className="w-6 h-6 md:w-8 md:h-8" />,
      title: "AI Integration",
      description: "Seamlessly integrating AI capabilities into existing systems and workflows for enhanced efficiency."
    }
  ];
  ...
  const processSteps = [
    {
      number: "01",
      title: "AI Assessment",
      description: "Analyzing your needs and identifying optimal AI solutions for your business goals."
    },
    {
      number: "02",
      title: "Data Strategy",
      description: "Developing comprehensive data strategies to power AI implementations."
    },
    {
      number: "03",
      title: "AI Development",
      description: "Building and training custom AI models tailored to your requirements."
    },
    {
      number: "04",
      title: "Deployment & Scale",
      description: "Implementing AI solutions and scaling them across your organization."
    }
  ];
        ...
        <div className="relative z-20 container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-gray-300 text-lg md:text-xl mb-8 md:mb-12 leading-relaxed max-w-2xl mx-auto">
              We harness the power of artificial intelligence to drive innovation and transform businesses.
            </p>
      ...
      <div className="relative min-h-screen flex items-center animate-on-scroll opacity-0 translate-y-10 transition-all duration-1000">
        ...
        <div className="relative z-10 container mx-auto px-4 py-20">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6 max-w-3xl">
            ...
            <span className="text-violet-400"> AI Innovation</span>
          </h2>
          <p className="text-gray-300 text-lg md:text-xl max-w-2xl">
            Our expertise in artificial intelligence enables businesses to leverage cutting-edge technology for competitive advantage.
          </p>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16 animate-on-scroll opacity-0 translate-y-10 transition-all duration-1000">
            ...
            <p className="text-gray-400 text-lg md:text-xl max-w-2xl mx-auto">
              Advanced artificial intelligence solutions that drive innovation and business transformation.
            </p>
          </div>
